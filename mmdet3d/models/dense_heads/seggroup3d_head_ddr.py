...
from pcdet.pcdet.ops.iou3d_nms import pcdet_nms_gpu, pcdet_nms_normal_gpu
...
class SegGroup3DHeadDDR(nn.Module):
    ...
    def forward(self, out, return_middle_feature=False):
        outs = []
        # inputs = x
        # x = inputs[-1]
        ...
        semantic_scores = self.semantic_conv(out) # 返回每一个点的语义分类
