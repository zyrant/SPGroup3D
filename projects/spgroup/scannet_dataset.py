...
from mmdet3d.core import show_result_v2_with_superpoint, show_seg_result
...
class SPScanNetDataset(Custom3DDataset):
    ...
    def show(self, results, out_dir, show=True, pipeline=None):
        ...
        for i, result in enumerate(results):
            ...
            points, superpoints = self._extract_data(i, pipeline, ['points', 'superpoints'], load_annos=True)
            points = points.numpy()
            superpoints = superpoints.numpy()
            ...
            show_result_v2_with_superpoint(points, superpoints, gt_bboxes, gt_labels,
