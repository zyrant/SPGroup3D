...
def export(anno_path, out_filename):
    ...
    '''
    Tips: 
    https://github.com/fpthink/3D-WSIS/blob/main/data/S3DIS/partition/partition_S3DIS.py
    很重要!!!!!!!!!!!!!!!!! 3D-WSIS 师兄tlh他们数据处理的时候将anno文件sort了
    '''
    objects = glob.glob(osp.join(anno_path, '*.txt'))
