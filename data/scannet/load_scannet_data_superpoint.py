...
def extract_superpoint(mesh_file, mesh_vertices, kThresh=0.01, segMinVerts=20):

    # https://github.com/fpthink/3D-WSIS/blob/main/data/ScanNetV2/prepare_data_inst_ScanNetV2.py
    ...
    superpoint = segment_mesh(_vertices, _faces).numpy()
...
def export(mesh_file,
    ...
    superpoint = extract_superpoint(mesh_file=mesh_file, mesh_vertices=mesh_vertices)
    ...
    if output_file is not None:
        ...
        np.save(output_file + '_superpoint.npy', superpoint)
        if not test_mode:
    ...
    return mesh_vertices, superpoint, label_ids, instance_ids, unaligned_bboxes, \
